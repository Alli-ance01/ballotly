...
export default function Account() {
  ...
  const register = trpc.auth.register.useMutation({ onSuccess: user => { utils.auth.me.setData(undefined, user); setLocation("/account/verify"); } });
  const login = trpc.auth.login.useMutation({ onSuccess: user => { utils.auth.me.setData(undefined, user); setLocation(user.emailVerifiedAt ? "/workspace" : "/account/verify"); } });

...
export default function Workspace() {
  ...
  const submit = (event: FormEvent) => {
    ...
    createOrganization.mutate({ name, slug, description: description || undefined }, { onSuccess: organization => { setDialogOpen(false); setLocation(`/workspace?org=${organization.id}`); } });
  };
